...
class DivisasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create divisa" do
    assert_difference('Divisa.count') do
      post divisas_url, params: { divisa: { año: @divisa.año, dia: @divisa.dia, mes: @divisa.mes, valor: @divisa.valor } }
    end
  ...
  test "should update divisa" do
    patch divisa_url(@divisa), params: { divisa: { año: @divisa.año, dia: @divisa.dia, mes: @divisa.mes, valor: @divisa.valor } }
