...
e=0;for(i=d.length;e<i;e++)if(c=d[e],b.isArray(c))q(a,c);else{g=f="";switch(c){case "ellipsis":f="&#x2026;";g="disabled";break;case "primero":f=k.sFirst;g=c+(0<j?"":" disabled");break;case "anteriores":f=k.sPrevious;g=c+(0<j?"":" disabled");break;case "siguiente":f=k.sNext;g=c+(j<n-1?"":" disabled");break;case "ultimo":f=k.sLast;g=c+(j<n-1?"":" disabled");break;default:f=c+1,g=j===c?"active":""}l=-1===g.indexOf("disabled")?"a":"div";f&&(l=b("<"+l+">",{"class":t.sPageButton+" "+g,id:0===r&&"string"===typeof c?
